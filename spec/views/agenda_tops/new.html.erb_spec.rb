...
describe "agenda_tops/new" do
  before(:each) do
    assign(:agenda_top, stub_model(AgendaTop,
  ...
  it "renders new agenda_top form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => agenda_tops_path, :method => "post" do
