...
describe "member_notification_preferences/new" do
  before(:each) do
    assign(:member_notification_preference, stub_model(MemberNotificationPreference,
      :member_id => 1,
  ...
  it "renders new member_notification_preference form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => member_notification_preferences_path, :method => "post" do
