...
describe "Registering a club " do
  ...
  it "should give correct error messages when partial data entered." do #,  :driver => :selenium  do
    visit log_in_path
    click_link('Register')
    ...
    fill_in "enrollment_password", :with => "monie423"
    click_button('Register')
    page.should have_content("prohibited this enrollment from")
    ...
    fill_in "enrollment_password", :with => "monie423"
    fill_in "enrollment_password_confirmation", :with => "monie423"
    click_button('Register')
    page.should_not have_content("prohibited this enrollment from")
